...
int main() {
    ...
    MovieDatabase database = MovieDatabase("films.txt");//creates a movie database from the given films.txt
    ...
    filmNoir.sortByDuration();//sorts the film noir database by duration longest to shortest
